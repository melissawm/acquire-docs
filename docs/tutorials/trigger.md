...
Every property can be set using the following syntax, but in this example, we will only change a few of the available settings. [Check out this tutorial](https://acquire-project.github.io/acquire-docs/tutorials/configure/) for an explanation of camera properties.
